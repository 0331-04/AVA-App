...
// ============================================================
//  AVA-Inspec — Auth Flow
//  File: lib/screens/auth_screen.dart
//
//  Contains 3 screens in one file:
//  1. TermsScreen      → shown first, must accept to proceed
//  2. LoginScreen      → default tab on auth screen
//  3. SignupScreen     → second tab on auth screen
//
//  Flow: TermsScreen → AuthScreen (Login/Signup tabs) → Dashboard
//
//  Extra features added:
//  ✅ Form validation (empty fields, email format, password match)
//  ✅ Password show/hide toggle
//  ✅ Must scroll & check checkbox before Accept activates on T&C
//  ✅ Keyboard-aware scroll so fields never hide behind keyboard
//  ✅ Google sign-in button placeholder (TODO: connect SDK)
// ============================================================
              ...
              Container(
                ...
                child: Stack(
                  children: [
                    ...
                    // e.g. Image.asset('assets/images/car_header.jpg', fit: BoxFit.cover)
                    Container(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  // Accept button — only active when checkbox checked
                  SizedBox(
                    width: 120,
                    height: 42,
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            // TODO: Connect Google Sign-In SDK
            SizedBox(
              width: double.infinity,
              height: 48,
...
//  Matches the Figma style — white card with label floating
//  above the border on the top-left edge
// ════════════════════════════════════════════════════════════
